...
soundData =
 [
  ["sound/sound/osirasesimasu.mp3", "お知らせします"],
  ["sound/sound/tugini.mp3", "次に"],
  ...
  ["sound/sound/7bannoriba-kara.mp3", "7番のりばから"],
  ["sound/sound/9bannoriba-kara.mp3", "9番のりばから"],
  ["sound/sound/11bannoriba-kara.mp3", "11番のりばから"],
  ...
  ["sound/sound/maruzirusino.mp3", "丸印の"],
  ...
  ["sound/sound/toutyakumade.mp3", "到着まで"],
  ["sound/sound/yaku6punndesu.mp3", "約6分です"],
  ["sound/sound/yaku10pundesu.mp3", "約10分です"],
  ["sound/sound/gomeiwakuwookakesimasugasibarakuomatikudasai.mp3", "ご迷惑をおかけしますがしばらくお待ち下さい"],
  ["sound/sound/honzituha.mp3", "本日は"],
  ["sound/sound/yukisakiwo.mp3", "行き先を"],
  ["sound/sound/yukini.mp3", "（行き先）行きに"],
  ["sound/sound/ryousuuwo.mp3", "両数を"],
  ["sound/sound/henkousiteorimasu.mp3", "変更しております"],
  ["sound/sound/gochuikudasai.mp3", "ご注意ください"],
  ...
  ["sound/sound/kakogawakakogawadesu.mp3", "加古川、加古川です"],
  ...
  ["sound/sound/koseisen.mp3", "湖西線"],
  ["sound/sound/saganosaninsen.mp3", "嵯峨野山陰線"],
  ["sound/sound/kankutokkyuharuka.mp3", "関空特急はるか"],
 ...
 soundData_silent =
  [
   ...
   ["sound/silent/null-500.mp3", "(0.5)"],
   ["sound/silent/null-750.mp3", "(0.75)"],
   ["sound/silent/null-1000.mp3", "(1.0)"],
 ...
 soundData_hour=
  [
   ...
   ["sound/hour/4ji.mp3", "4時"],
   ["sound/hour/6ji.mp3", "6時"],
   ["sound/hour/7ji.mp3", "7時"],
   ["sound/hour/8ji.mp3", "8時"],
   ["sound/hour/9ji.mp3", "9時"],
   ["sound/hour/12ji.mp3", "12時"],
   ["sound/hour/15ji.mp3", "15時"],
   ["sound/hour/16ji.mp3", "16時"],
   ["sound/hour/17ji.mp3", "17時"],
 ...
 [
  ...
  ["sound/minute/3hun-hatsu.mp3", "03分発"],
  ["sound/minute/7hun-hatsu.mp3", "07分発"],
  ["sound/minute/9hun-hatsu.mp3", "09分発"],
  ["sound/minute/11hun-hatsu.mp3", "11分発"],
  ["sound/minute/15hun-hatsu.mp3", "15分発"],
  ["sound/minute/23hun-hatsu.mp3", "23分発"],
  ["sound/minute/31hun-hatsu.mp3", "31分発"],
  ["sound/minute/34hun-hatsu.mp3", "34分発"],
  ["sound/minute/37hun-hatsu.mp3", "37分発"],
  ["sound/minute/37hun-hatsu.mp3", "43分発"],
  ["sound/minute/54hun-hatsu.mp3", "54分発"],
  ["sound/minute/56hun-hatsu.mp3", "56分発"],
  ["sound/minute/59hun-hatsu.mp3", "59分発"],
  ["sound/sound/null-250.mp3", ""] //この最後の行は編集しないでください

 ]
 soundData_for=
  [
   ["sound/bound(for)/JRtouzaisenkeiyu.mp3", "JR東西線経由"],
   ["sound/bound(for)/koseisen-keiyu.mp3", "湖西線経由"],
   ["sound/bound(for)/sanyousen-keiyu.mp3", "山陽線経由"],
   ["sound/bound(for)/himeji-homen.mp3", "姫路方面"],
   ["sound/bound(for)/kobe-homen.mp3", "神戸方面"],
   ["sound/bound(for)/kyoto-homen.mp3", "京都方面"],
   ["sound/bound(for)/maibara-homen.mp3", "米原方面"],
   ["sound/bound(for)/joyo-yukiha.mp3", "城　陽(行)"],
   ["sound/bound(for)/sonobe-yukiha.mp3", "園　部(行)"],
   ["sound/bound(for)/sappro.mp3", "札　幌(行)"],
   ...
   ["sound/bound(for)/yasu_yukiha.mp3", "野　洲(行)"],
   ["sound/bound(for)/kusatu_yukiha.mp3", "草　津(行き)"],
   ...
   ["sound/bound(for)/matsuiyamate_yukiha.mp3", "松井山手(行)"],
   ["sound/bound(for)/kobe_yukiha.mp3", "神　戸(行)"],
   ["sound/bound(for)/nishiakashi_yukiha.mp3", "西 明 石(行)"],
   ["sound/bound(for)/tsuchiyama_yukiha.mp3", "土　山(行)"],
   ["sound/bound(for)/kakogawa_yukiha.mp3", "加 古 川(行)"],
   ["sound/bound(for)/himeji_yukiha.mp3", "姫　路(行)"],
   ["sound/bound(for)/banshu-ako_yukiha.mp3", "播州赤穂(行)"],
   ["sound/bound(for)/kamigoori_yukiha.mp3", "上　郡(行)"],
   ["sound/bound(for)/kurayosi_yukiha.mp3", "倉　吉(行)"],
 ...
 soundData_and=
  [
   ...
   ["sound/dest(and)/atami.mp3", "熱海"],
   ["sound/dest(and)/numazu.mp3", "沼津"],
   ["sound/dest(and)/huzi.mp3", "富士"],
   ["sound/dest(and)/sizuoka.mp3", "静岡"],
   ["sound/dest(and)/kanazawa.mp3", "金沢"],
   ["sound/dest(and)/komatu.mp3", "小松"],
   ["sound/dest(and)/kagaonnsenn.mp3", "加賀温泉"],
   ["sound/dest(and)/awaraonsenn.mp3", "芦原温泉"],
   ["sound/dest(and)/hukui.mp3", "福井"],
   ["sound/dest(and)/sabae.mp3", "鯖江"],
   ["sound/dest(and)/takehu.mp3", "武生"],
   ["sound/dest(and)/turuga.mp3", "敦賀"],
   ["sound/dest(and)/moriyama.mp3", "守山"],
   ["sound/dest(and)/kusatu.mp3", "草津"],
   ["sound/dest(and)/ishiyama.mp3", "石山"],
   ["sound/dest(and)/zeze.mp3", "膳所"],
   ["sound/dest(and)/otu.mp3", "大津"],
   ["sound/dest(and)/yamashina.mp3", "山科"],
   ["sound/dest(and)/otukyou.mp3", "大津京"],
   ["sound/dest(and)/hieizansakamoto.mp3", "比叡山坂本"],
   ["sound/dest(and)/katata.mp3", "堅田"],
   ["sound/dest(and)/oumimaiko.mp3", "近江舞子"],
   ["sound/dest(and)/kyoto.mp3", "京都"],
   ["sound/dest(and)/nijo.mp3", "二条"],
   ["sound/dest(and)/enmachi.mp3", "円町"],
   ["sound/dest(and)/sagaarasiyama.mp3", "嵯峨嵐山"],
   ["sound/dest(and)/kameoka.mp3", "亀岡"],
   ["sound/dest(and)/takatsuki.mp3", "高槻"],
   ["sound/dest(and)/shinosaka.mp3", "新大阪"],
   ["sound/dest(and)/osaka.mp3", "大阪"],
   ["sound/dest(and)/amagasaki.mp3", "尼崎"],
   ["sound/dest(and)/asiya.mp3", "芦屋"],
   ["sound/dest(and)/sannomiya.mp3", "三ノ宮"],
   ["sound/dest(and)/kobe.mp3", "神戸"],
   ["sound/dest(and)/suma.mp3", "須磨"],
   ["sound/dest(and)/tarumi.mp3", "垂水"],
   ["sound/dest(and)/maiko.mp3", "舞子"],
...
[
  ...
  ["sound/melody/yokoku-chime-kyoto-k.mp3", "♪予告チャイム @京都線"],
  ["sound/melody/yokoku-chime-kyoto.mp3", "♪予告メロディ @京都線"],
  ["sound/melody/yokoku-chime.mp3", "♪予告メロディ @神戸線"],

  ["sound/melody/chime-kobe.mp3", "♪神戸線チャイム"],
  ["sound/melody/chime-kyoto.mp3", "♪京都駅チャイム"],
  ["sound/melody/chime-kyotos-k.mp3", "♪旧京都駅チャイム"],
  ["sound/melody/chime-osaka.mp3", "♪大阪駅チャイム"],
  ["sound/melody/chime-osaka-k.mp3", "♪旧大阪駅チャイム"],

  ["sound/melody/sekkin-kobe.mp3", "♪神戸線接近メロディ"],
  ["sound/melody/sekkin-kobe-k.mp3", "♪旧神戸線接近メロディ"],
  ["sound/melody/sekkin-kyoto-k.mp3", "♪京都線接近メロディ"],
  ["sound/melody/sekkin-kyoto.mp3", "♪京都駅接近メロディ"],
  ["sound/melody/sekkin-kyotos-k.mp3", "♪旧京都駅接近メロディ"],
  ["sound/melody/sekiin-osaka.mp3", "♪大阪駅接近メロディ"],
  ["sound/melody/sekkin-osaka-k.mp3", "♪旧大阪駅接近メロディ"],
...
[
  ...
  ["sound/type/rapid.mp3", "快　速"],
  ["sound/type/specialrapidservise.mp3", "新快速"],
  ...
  ["sound/type/biwakosen.mp3", "琵琶湖線"],
  ["sound/type/2gou.mp3", "2号"],
  ["sound/type/10gou.mp3", "10号"],
  ["sound/type/11gou.mp3", "11号"],
  ["sound/type/17gou.mp3", "17号"],
  ["sound/type/18gou.mp3", "18号"],
  ["sound/type/23gou.mp3", "23号"],
  ["sound/type/25gou.mp3", "25号"],
...
[
  ...
  ["sound/cars(ryousu)/4ryou-de.mp3", "4両で"],
  ["sound/cars(ryousu)/5ryou-de.mp3", "5両で"],
  ["sound/cars(ryousu)/6ryou-de.mp3", "6両で"],
  ["sound/cars(ryousu)/7ryou-de.mp3", "7両で"],
  ["sound/cars(ryousu)/8ryou-de.mp3", "8両で"],
  ["sound/cars(ryousu)/9ryou-de.mp3", "9両で"],
